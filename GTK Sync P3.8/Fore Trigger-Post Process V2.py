                ...
                if files.endswith(".xlsx"):
                    ...
                    for press in press_frames_force and press_frames_force:
                        ...
                        if not os.path.exists(full_path+'/'+folders+' Plots/'+sn+'-'+position+' Press '+str(l+1)+'.png'):
                            ...
                            ax2 = ax1.twinx()
                            ax2.plot(adctime,adc_normal, label='Fore ADC', color='green')
                        ...
                        if adc_hard_stop_2['Fore ADC'] - min_ADC < 25:
                            Saturated = 'Yes'
                        else:
                            Saturated = 'No'
                        ...
                        Data_Values = {'S/N': [sn],
                                       ...
                                       'Position': [position],
                                       'Press': [(l+1)],
                                       'ADC @ Hardstop 1': [adc_hard_stop_2['Fore ADC']],
                                       'ADC @ Hardstop 2': [adc_hard_stop_4['Fore ADC']],
                                       'Saturated': [Saturated],
                                       '0N ADC': [max_ADC],
                                       '7N ADC': [min_ADC],
